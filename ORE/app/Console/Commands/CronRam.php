...
class CronRam extends Command
{
     ...
     * @var string
     */
    protected $signature = 'Cron:CronRam';
     ...
     * @var string
     */
    protected $description = 'Entire Ram Master Memory Loaded';
   ...
   // protected $brand_array = array('alfa_romeo','fiat','chrysler','dodge','jeep','ram');
	...
	protected $brand_array = array('ram');
	...
	protected $vehicle_type_array_new = array('new');
	...
	*/
	...
	public function MasterVehicle($params_vechType, $params_make, $params_year, $params_model){ 
		...
		try{
				$vehicleParamsCacheKey = str_replace('-', '_', Databucket::makeCache('vehicle_table_'.$params_make.$params_vechType.'_'.$params_year.strtolower(str_replace(' ', '_', $params_model))));
