	...
	<div class="header-scroll">
		<div class="container">
			<div class="row no-gutters">
				...
				@if($page == 'landing')
					<a tabindex="2" href="{{  env('APP_URL') }}" class="imageFrame alfa-sni-frame top-logo-vehicle home-logo">
				...
				@else 
					<a tabindex="2" href="{{  env('APP_URL') }}{{ $params_make }}" class="imageFrame alfa-sni-frame top-logo-vehicle sni-vdp-logo">
						...
						@else
								@if($params_make == 'jeep' || $params_make == 'chrysler')
										<img alt="{{ $params_make }}" title="{{ $params_make }}" src="{{ cdn('images/logos/2x/cdjr-logo-'.$params_make.'tm.png') }}"   />
									@else
										<img alt="{{ $params_make }}" title="{{ $params_make }}" src="{{ cdn('images/logos/2x/cdjr-logo-'.$params_make.'.png') }}"   />
									@endif	
