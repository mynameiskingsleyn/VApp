...
<table cellpadding="0" cellspacing="0" border="0" align="center" width="650px" style="font-family: arial; font-size: 17px; line-height: 34px; border: 1px solid #05485e; border-bottom-left-radius: 15px; border-bottom-right-radius: 15px;">
	<tr>
		<td style="background: #05485e; text-align: center; padding: 10px; color: #ffffff; padding: 20px;" valign="top">Drive Alfa Romeo - Dealer Inventory Health Check</td>
	</tr>
	<tr>
		<td style="padding: 20px" valign="top">
				<p style="margin-top: 0px;"> Hello Team,</p> 				
				<p style="margin-bottom: 10px;">Below Dealers(out of 130) doesn't contain any vehicles in Drive Alfa Romeo platform. Please review the below list:</p>				
