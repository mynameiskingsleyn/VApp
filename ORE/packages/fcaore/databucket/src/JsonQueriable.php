...
namespace Fcaore\Databucket;

use Fcaore\Databucket\Exceptions\ConditionNotAllowedException;
use Fcaore\Databucket\Exceptions\FileNotFoundException;
use Fcaore\Databucket\Exceptions\InvalidJsonException;
use Fcaore\Databucket\Results\ValueNotFound;
use Fcaore\Databucket\Condition;
...
trait JsonQueriable
{
	...
	/**
     * make OR WHERE IN clause
     *
     * @param string $key
     * @param array $value
     * @return $this
     */
    public function orWhereIn($key = null, $value = [])
    {
        $this->orWhere($key, 'in', $value);
