...
<div class="container" style="margin-top:60px">
 <div class="row">
   ...
   <a href="swagger_calc_quote_resource_finance.php" class="btn btn-success">GOTO FINANCE</a>
</div> 


  <div class="row">
		
	<div class="standard_lease">	
		<br>
		<h5>STANDARD LEASE</h5>
		<hr>
		
		
       <form method="post" action="swagger_calc_quote_resource_standardlease.php#result">
...
<div class="form-group"><input type="hidden" name="form_submit">
			...
			<div class="col-md-6">	
					  ...
					  <div class="form-group">
						 ...
						 <div class="form-group">
							<label for="terms">Miles Per Year *</label>
								<select name="milesPerYear" class="form-control" required>
									<option value="10000" <?php if($milesPerYear==10000){?> selected <?php }?>>10000</option>
									<option value="12000" <?php if($milesPerYear==12000){?> selected <?php }?> >12000</option> 
								</select> 
						</div>
					...
					<input type="number" class="form-control" id="tradeIn" name="tradeIn" value=<?php echo $tradeIn; ?>" required>
				  </div>
				  <div class="form-group"> 
	...
	<br>
       ...
       <form method="post" action="swagger_calc_quote_resource_finance.php#result">
			...
			<div class="col-md-6">		
				  ...
				  <div class="form-group">
					<label for="msrp">MSRP *</label>
					<input type="text" class="form-control" id="msrp" name="msrp" value="0"  required>
				  </div>
				   <div class="form-group">
					<label for="msrp">Zipcode *</label>
					<input type="number" class="form-control" id="zip" name="zip" maxlength="5" value="48302"  required>
				  </div>dddd
				  <div class="form-group"> 
					<label for="TradeIn">Dealer Code *</label>
					<input type="number" class="form-control" id="dealercode" name="dealercode" value="69008" required>
				  </div>
			</div>	
			<div class="col-md-6">	
					  ...
					  <div class="form-group">
							<label for="cashdown">Cashdown *</label>
							<input type="number" class="form-control" id="cashdown" name="cashdown" maxlength="5"   value="0" required>
						</div>
						
						 <div class="form-group">
							<label for="terms">Terms (Month) *</label> 
							<select name="terms" class="form-control" required>
						...
						<div class="form-group">
							<label for="financeSource">Finance Soruce *</label>
								<select name="financeSource" class="form-control" required>
									<option value="F000BA">Ally</option>
									<option value="F00CHC">Chrsler Captial</option> 
								</select> 
						</div>
						<div class="form-group"><input type="hidden" name="form_submit" >
					<label for="TradeIn">TradeIn *</label>
					<input type="number" class="form-control" id="tradeIn" name="tradeIn" value="0" required>
				  </div>
...
**************************************************/ 
		...
		$XRouteoneAPIResource 		= '/customer-quote/standardLease';  
		if(isset($_POST['form_submit'])){
			$tradeIn = 0;
			if(isset($_POST['tradeIn'])) $tradeIn = $_POST['tradeIn']; else $tradeIn = 0;
			if(isset($_POST['vin'])) $vehicle_vin = $_POST['vin']; else $vehicle_vin = 'ZARFAMAN6K7612678';
	...
	if(isset($_POST['financeSource'])) $financeSource = $_POST['financeSource']; else $financeSource = 'F000BA';			  
		...
		echo "<h3>customer-quote-resource => /customer-quote/standardLease</h3>";			
