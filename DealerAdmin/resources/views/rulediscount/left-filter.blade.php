        ...
        <div animationduration="0ms" class="mat-tab-group mat-primary">
            ...
            <div class="mat-tab-body-wrapper">
                        ...
                        <div class="dropDownPanel ng-star-inserted" style="">
                            ...
                            <div class="field financeOption">
                                ...
                                <div class="custom-control custom-radio">
                                    <input type="radio" class="custom-control-input" id="defaultGroupExample1" name="auto_finance_option" value="1" checked>
                                    <label class="custom-control-label" for="defaultGroupExample1">Lease</label>
                                </div>
                                <div class="custom-control custom-radio">
                                    <input type="radio" class="custom-control-input" id="defaultGroupExample2" name="auto_finance_option" value="2">
                                    <label class="custom-control-label" for="defaultGroupExample2">Finance</label>
                                </div>
                                
                                <div class="custom-control custom-radio last-option">
                                    <input type="radio" class="custom-control-input" id="defaultGroupExample3" name="auto_finance_option" value="3">
                            ...
                            <div class="field trimField">
                               <!--  <select class="da_auto_event_trim" name="da_auto_event_trim[]" multiple id="da_auto_event_trim"> -->
                                <select class="da_auto_event_trim" name="da_auto_event_trim" id="da_auto_event_trim">
                                    <option value="" class="ng-star-inserted"> Choose Trim Level </option>
                                </select>
                            </div>
                            <div class="field discountViewOption">
                                
                                <div class="create-view-saved-btn-field">
                                   <button class="btn theme" id="CreatedDiscountBtn" onclick="createDiscountBtn()">Create Discounts <img src="img/svg/add-white.svg"> </button>   
                                    <button class="btn theme"  id="SavedDiscountBtn" onclick="savedDiscountBtn()" >View Saved Discounts <i class="fa fa-save" aria-hidden="true"></i></button>
                                </div>
                               <!--  <div class="custom-control custom-radio">
                ...
                <!-- <div class="goFilterBtn automatedcreateDiscountBtn">
                    <button class="disabled" name="searchButton" id="CreatedDiscountBtn" onclick="createDiscountBtn()" type="button">CREATE DISCOUNTS <img src="img/svg/add-white.svg"> </button><span class="error-check">Please Enter a Valid VIN Number</span>
