    <div class="modal delete_popup fade" id="conforamtion_discount_popup_modal" tabindex="-1" role="dialog" aria-labelledby="discount_delete_ModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" id="confirm-discount-btn" class="btn rift-soft gcss-button confirm-discount-btn" data-dismiss="modal">Continue</button>
                </div>
            </div>
        </div>
    </div>